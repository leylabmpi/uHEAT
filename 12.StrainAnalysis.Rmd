...
#Time01
#pdf(width=4, height=3, "/ebio/abt3_projects2/uHEAT/data/RevisionPlots/S5G_inStrain_persistance_overtime.pdf")
p <- ggplot(pdata, aes(x=Time01_2, y=persistence_zscore, colour=fever7d_aboveavg)) + 
  ...
  annotate('text', x=3, y=2, label=c("Time p=0.03\nFever p=0.97\nTime:Fever p=0.96"), hjust=0, size=2.5)
p
#dev.off()
...
#pdf(width=4, height=3, "/ebio/abt3_projects2/uHEAT/data/RevisionPlots/S5H_inStrain_evolution_overtime.pdf")
p <- ggplot(pdata, aes(x=Time01_2, y=evolution_zscore, colour=fever7d_aboveavg)) + 
  ...
  scale_x_continuous(breaks = (seq(-7, 7, by = 7)), lim=c(-7, 7)) +
  annotate('text', x=3, y=2, label=c("Time p=0.37\nFever p=0.08\nTime:Fever p=0.71"), hjust=0, size=2.5)
p
#dev.off()
