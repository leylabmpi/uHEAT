...
#pdf(width=2.5, height=3, "/ebio/abt3_projects2/uHEAT/data/RevisionPlots/5C_Wi_vs_others_CMC_simple_reps123.pdf")
...
wcell_htlr5$Condition <- gsub("Wi", "Waltera", wcell_htlr5$Condition)
wcell_htlr5$Condition <- gsub("PBS", "Blank", wcell_htlr5$Condition)

#pdf(width=2, height=3, "/ebio/abt3_projects2/uHEAT/data/RevisionPlots/3G.WalteraFliC.pdf")
p <- ggplot(wcell_htlr5, aes(x=Condition, y=FliC)) + geom_boxplot(outlier.shape=NA) + 
  ...
  annotate('text', x=1.5, y=0.82, label="*", size=6) 
p
#dev.off()
