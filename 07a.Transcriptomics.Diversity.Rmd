...
#pdf("/ebio/abt3_projects2/uHEAT/data/RevisionPlots/S7B.TranscriptomicsBrayTemporalFever.pdf", width=4, height=3)
p <- ggplot(brayq2_meta, aes(x=Time01, y=Bray_Distance, colour=fever7d_aboveavg)) + 
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
               panel.background = element_blank(), axis.line = element_line(colour = "black"),
               axis.title.y = element_text(margin = margin(r = 10))) + 
  xlab("Time (days)") + ylab("Bray Curtis Dissimilarity") + ggtitle("RNA Distance to Self") + labs(colour="Fever") +
  ...
  annotate('text', x=3, y=0.65, label=c("Time p=0.18\nFever p=0.65\nTime:Fever p=0.34"), hjust=0, size=2.5)
p
#dev.off()
...
#pdf("/ebio/abt3_projects2/uHEAT/data/RevisionPlots/S7C.TranscriptomicsBrayTemporalFeverPathway.pdf", width=4, height=3)
p <- ggplot(brayq2_meta, aes(x=Time01, y=Bray_Distance, colour=fever7d_aboveavg)) + 
  #geom_point() +
  geom_line(aes(group=Participant_ID), alpha=0.3) +
  geom_smooth(method='loess', fill='white', alpha=0.7) + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
               panel.background = element_blank(), axis.line = element_line(colour = "black"),
               axis.title.y = element_text(margin = margin(r = 10))) + 
  xlab("Time (days)") + ylab("Bray Curtis Dissimilarity") + ggtitle("RNA Distance to Self (Pathways)") + labs(colour="Fever") +
  scale_x_continuous(breaks = (seq(-7, 7, by = 7))) + 
  scale_colour_manual(values=c("grey50", "firebrick3")) + 
  annotate('segment', x=0, xend=0, y=0.1, yend=0.9, linetype='dashed') +
  annotate('text', x=3, y=0.85, label=c("Time p=0.37\nFever p=0.56\nTime:Fever p=0.09"), hjust=0, size=2.5)
p
#dev.off()
...
#cairo_pdf("/ebio/abt3_projects2/uHEAT/data/RevisionPlots/S7A.RNAShannonTemporalFever.pdf", width=4, height=3)
p <- ggplot(pdata, aes(x=Time01, y=shannon_entropy, colour=fever7d_aboveavg)) + 
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
               panel.background = element_blank(), axis.line = element_line(colour = "black"),
               axis.title.y = element_text(margin = margin(r = 10))) + 
  xlab("Time (days)") + ylab("Shannon entropy") + ggtitle("RNA Alpha Diversity") + labs(colour="Fever") +
  scale_x_continuous(breaks = (seq(-7, 7, by = 7))) + 
  scale_colour_manual(values=c("grey50", "firebrick3")) + 
  annotate('segment', x=0, xend=0, y=3, yend=9, linetype='dashed') +
  annotate('text', x=3, y=8.5, label=c("Time p=0.91\nFever p=0.94\nTime:Fever p=0.63"), hjust=0, size=2.5)
p
#dev.off()
